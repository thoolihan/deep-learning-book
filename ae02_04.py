...
encoded = layers.Dense(ENCODING_DIM[0], activation='relu', activity_regularizer=regularizers.l1(ACTIVITY_REG))(input_img)
encoded = layers.Dense(ENCODING_DIM[1], activation='relu', activity_regularizer=regularizers.l1(ACTIVITY_REG))(encoded)
encoded = layers.Dense(ENCODING_DIM[2], activation='relu', activity_regularizer=regularizers.l1(ACTIVITY_REG))(encoded)

decoded = layers.Dense(ENCODING_DIM[1], activation='relu', activity_regularizer=regularizers.l1(ACTIVITY_REG))(encoded)
decoded = layers.Dense(ENCODING_DIM[0], activation='relu', activity_regularizer=regularizers.l1(ACTIVITY_REG))(decoded)
